      ...
      <main className="flex flex-col self-center px-5 mt-36 w-full max-w-[1300px] max-md:mt-10 max-md:max-w-full">
        ...
        <section className="flex flex-col mt-10 max-md:max-w-full">
          ...
          <nav className="flex gap-2.5 self-center mt-5" aria-label="News pagination">
            <div className="shrink-0 w-10 h-2.5 rounded-xl bg-slate-400" role="button" tabIndex="0" aria-label="Page 1"></div>
            <div className="shrink-0 w-10 h-2.5 rounded-xl bg-slate-300" role="button" tabIndex="0" aria-label="Page 2"></div>
            <div className="shrink-0 w-10 h-2.5 rounded-xl bg-slate-300" role="button" tabIndex="0" aria-label="Page 3"></div>
            <div className="shrink-0 w-10 h-2.5 rounded-xl bg-slate-300" role="button" tabIndex="0" aria-label="Page 4"></div>
          </nav>
        </section>
      </main>
